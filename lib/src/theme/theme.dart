...
ThemeData themeData = ThemeData(
  ...
  textTheme: TextTheme(
    displayLarge: _style(size: 40.sp, weight: FontWeight.w700),
    displayMedium: _style(size: 36.sp, weight: FontWeight.w700),
    displaySmall: _style(size: 24.sp, weight: FontWeight.w700),
    headlineMedium: _style(size: 20.sp, weight: FontWeight.w700),
    headlineSmall: _style(size: 14, weight: FontWeight.w700),
    titleLarge: _style(size: 12, weight: FontWeight.w700),
    bodyLarge: _style(size: 16.sp),
    bodyMedium: _style(size: 12.sp),
    titleMedium: _style(size: 14.sp),
    titleSmall: _style(size: 12.sp),
  ),
